                   ...
                   <div class="page-header">
                    <div class="page-header-content">
                        <div class="page-title">
                            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">GSM Net Master</h4>

                        <div class="heading-elements">
                            <a href="{{ route('gsmmaster.create') }}" class="btn bg-blue btn-labeled heading-btn"><b><i class="icon-plus3"></i></b> Create New</a>
                        </div>
                    </div>
                </div>
                <!-- /page header -->
...
<script>
    ...
    $('.datatable-basic').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ url('gsmmaster/getData') }}',
            columns: [
            { data: 'gsm_name', name: 'gsm_name' },
