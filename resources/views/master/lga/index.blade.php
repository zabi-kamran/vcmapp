            ...
            <div class="content-wrapper">
                   <div class="page-header">
                    <div class="page-header-content">
                        <div class="page-title">
                            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">LGA Master</h4>

                        <div class="heading-elements">
                            <a href="{{ route('lgamaster.create') }}" class="btn bg-blue btn-labeled heading-btn"><b><i class="icon-plus3"></i></b> Create New</a>
                        </div>
                    </div>
                </div>
                <!-- /page header -->
                ...
                <div class="content">
                    ...
                    <div class="panel panel-flat">
                        <table class="table datatable-basic table-condensed" id="datatable">
                            <thead>
                                <tr>
                                   {{--  <th>S.No</th> --}}
                                    <th>LGA Name</th>
...
<script>
    ...
    $('.datatable-basic').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ url('lgamaster/getData') }}',
            columns: [
            // {data: 'rownum', name: 'rownum', searchable: false},
            { data: 'lga_name', name: 'lga_name' },
