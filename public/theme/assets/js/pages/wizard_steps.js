...
$(function() {
    ...
    $(".steps-validation").steps({
        ...
        onStepChanged: function (event, currentIndex, priorIndex) {
            ...
            if(currentIndex === 2){
                 $('.steps-validation').find('a[href="#finish"]').remove(); 
                 $('.steps-validation .actions li:last-child').append('<button type="submit" id="submit" class="btn btn-primary">Authorize Payment <span class="icon-arrow-right14 position-right"></span></button>');
            }
            else{
                 $('.steps-validation').find('button').remove(); 
            }
